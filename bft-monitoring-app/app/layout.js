...
import { PlaybackProvider } from "@context/PlaybackContext"; // <-- import playback
...
import MapEmbed from "@components/MapEmbed"; // your existing map component
import "./globals.css";
      ...
      <body className="app-root">
        ...
        <MapProvider>
          <DeviceProvider setActivePanel={setActivePanel}>
            {/* Wrap PlaybackProvider around map and playback panel */}
            <PlaybackProvider>
